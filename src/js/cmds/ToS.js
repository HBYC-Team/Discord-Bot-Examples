...
module.exports = {
	...
	async execute(interaction){
		...
		const ToSEmbed = new EmbedBuilder()
			.setTitle("HBYC的服務條款")
			.addFields(
				{ name: "中文版", value: "https://github.com/dragonyc1002/HBYC/tree/master/docs/TeamofService-Tw.md" },
				{ name: "English Version", value: "https://github.com/dragonyc1002/HBYC/tree/master/docs/TeamofService.md" }
			)
			.setTimestamp()
